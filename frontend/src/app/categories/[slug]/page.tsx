...
import { getCategoryBySlug, getCategories, getArticlesByCategory } from '@/lib/strapi';
...
export default async function CategoryPage({ params }: Props) {
    ...
    try {
        const [catRes, artRes] = await Promise.all([getCategoryBySlug(slug), getArticlesByCategory(slug)]);
